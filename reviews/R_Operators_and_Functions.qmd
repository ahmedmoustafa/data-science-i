---
title: "R Essentail Operators & Functions"
format:
  pdf:
    fontsize: 6pt
...
| Function  | Syntax                     | Description                                           | Example Usage              | Example Output           |
|-----------|----------------------------|-------------------------------------------------------|--------------------------------|--------------------------|
...
| summary   | `summary(object)`         | Provides a concise summary of object `x`             | `summary(c(1, 2, 3, 4, 5))` | Min. 1st Qu. Median Mean 3rd Qu. Max. |
...
| str       | `str(object)`             | Displays the internal structure of an R object. | `str(data.frame(x = 1:3, y = c("A", "B", "C")))` | 'data.frame': 3 obs. of  2 variables. |
